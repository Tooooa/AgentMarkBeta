...
- 证据强度实验：`evidence_strength/` 已生成 4.1 解码置信度曲线、4.2 最小证据阈值、4.3 鲁棒性补偿分析。
...
- `evidence_strength/`：证据强度实验结果，包含 step-level 证据观测、二项检验 p-value 曲线、最小证据阈值、鲁棒性补偿表与 PNG 图。
...
less evidence_strength/README.md
