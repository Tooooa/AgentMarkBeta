...
- Paper build: `paper.tex`, `references.bib`, and `Makefile` are sufficient to rebuild the PDF.
...
- Result source: `output/asym_agentmark_tk/week2_postprocess/*.csv` contains the postprocessed trajectory metrics used for the utility, JSD, capacity, top-k, rank-noise, and erasure tables.
