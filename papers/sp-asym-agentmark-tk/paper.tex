...
\begin{itemize}[leftmargin=*]
  ...
  \item \textbf{Low false positives}: a clean or unrelated trajectory should recover a pre-registered claimed $L$-bit payload with probability approximately $2^{-L}$ when decoded bits are independent of the claim.
