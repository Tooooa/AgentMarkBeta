...
Provably secure steganography formalizes indistinguishability between cover and stego content~\cite{hopper2002provably}. Meteor provides a practical cryptographic construction for realistic distributions~\cite{kaptchuk2021meteor}, while later work improves payload embedding under language-model channels through undetectable or sparse-sampling constructions~\cite{christ2024undetectable,zamir2024steganography,sparsamp2025}. Weakly asymmetric steganography studies receivers with partial channel knowledge~\cite{weakasym2026}. \ours{} adapts this idea from token/text channels to planning-behavior channels: the sender still needs full behavior probabilities to preserve the policy, but the verifier decodes from rank order alone.
