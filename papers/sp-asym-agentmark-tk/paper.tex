...
\begin{itemize}[leftmargin=*]
  ...
  \item Live L5 cross-model rerank: \path{l5_rank_depth_calibration.csv}, \path{l5_rank_depth_pool_curve.csv}, built from \path{l5_toolbench_rank_topk_matched_clean_w100} and \path{l5_toolbench_rank_top2_top4_matched_clean_w100}.
