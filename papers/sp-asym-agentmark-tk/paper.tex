...
The rest of the paper proceeds as follows. Section~II motivates behavioral watermarking and weak asymmetry. Section~III defines the agent behavior channel, adversary, and verifier knowledge. Section~IV presents the rank encoder, decoder, synchronization, and coding layer. Sections~V and VI analyze security and evaluate utility, stealth, and rank-only recovery. Sections~VII--IX discuss operational limits, related work, validity, ethics, and conclusions.
