...
\begin{table}[t]
\centering
\caption{Offline 8-bit decoder proxy under verifier channel knowledge. Cells show payload recovery / bit-match rate; Sel. only is the selected-behavior-only negative control.}
\label{tab:capacity}
